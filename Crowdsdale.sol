 ...
 *  Make `re to implement the best practices you learned during the Solidity Walkthrough segment.
...
contract Crowdsale{
    ...
    */
    constructor(uint256 _rate, address _wallet, CannabisToken _token) {
    ...
    function _deliverTokens(address _beneficiary, uint256 _tokenAmount) internal {
        ...
        require(CannabisToken(token).mint(_beneficiary, _tokenAmount));
  }
